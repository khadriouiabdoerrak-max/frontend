...
export const metadata: Metadata = {
  ...
  description:
    'أجوبة تاجكِ حول الدفع عند الاستلام، التوصيل فالمغرب، تأكيد الطلب، وروتين OXIPRIME الكامل.',
};

const faqs = [
  {
    q: 'شنو هي تاجكِ؟',
    a: 'تاجكِ هي الدار المغربية لروتين إصلاح الشعر الكامل. كنختارو ليكِ روتين OXIPRIME من 4 خطوات، مع دفع عند الاستلام وتأكيد بالهاتف.',
  },
  {
