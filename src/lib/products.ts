...
export const products: Product[] = [
  {
    ...
    price: 199,
    isBundle: false,
    image: "/images/oxiprime-shampoo-realistic.webp",
    usageImage: "/images/oxiprime-shampoo-use-realistic.webp",
    resultImage: "/images/oxiprime-smooth-hair-result.webp",
    rating: 4.8,
    step: 1,
    stepLabel: "ينظف بلطف",
    benefits: [
  ...
  },
  {
    ...
    price: 199,
    isBundle: false,
    image: "/images/oxiprime-conditioner-realistic.webp",
    usageImage: "/images/oxiprime-conditioner-use-realistic.webp",
    resultImage: "/images/oxiprime-smooth-hair-result.webp",
    rating: 4.8,
    step: 2,
  ...
  },
  {
    ...
    price: 199,
    isBundle: false,
    image: "/images/oxiprime-mask-realistic.webp",
    usageImage: "/images/oxiprime-mask-use-realistic.webp",
    resultImage: "/images/oxiprime-smooth-hair-result.webp",
    rating: 4.9,
    step: 3,
    stepLabel: "يغذي بعمق",
  ...
  },
  {
    ...
    price: 199,
    isBundle: false,
    image: "/images/oxiprime-serum-realistic.webp",
    usageImage: "/images/oxiprime-serum-use-realistic.webp",
    resultImage: "/images/oxiprime-smooth-hair-result.webp",
    rating: 4.9,
    step: 4,
...
export const bundleProduct: Product = {
  ...
  shortDescriptionAr:
    "اختيار تاجكِ: شامبو + بلسم + ماسك + سيروم — روتين إصلاح كامل.",
  descriptionAr:
    "اختيار تاجكِ الأول: روتين OXIPRIME الكامل لإصلاح الشعر. باك واحد يجمع التنظيف، الترطيب، التغذية والحماية — لشعر أقوى، أنعم، وأكثر لمعاناً، مع دفع عند الاستلام داخل المغرب.",
  price: 599,
  compareAtPrice: 796,
  isBundle: true,
  image: "/images/oxiprime-bundle-clear-products.webp",
  rating: 4.9,
  benefits: [
...
const listImages: Record<string, string> = {
  ...
  'complete-hair-repair-kit': '/images/oxiprime-bundle-clear-products.webp',
};
