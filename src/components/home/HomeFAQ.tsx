...
const FAQS = [
  {
    q: 'علاش تاجكِ كتركّز على الروتين الكامل؟',
    a: 'لأن إصلاح الشعر كيحتاج ترتيب: تنظيف، ترطيب، تغذية، وحماية. منتج واحد كيحل جزء من المشكل؛ الروتين الكامل كيعطي نتيجة أوضح.',
  },
  {
    q: 'هل المنتجات مناسبة للشعر المتضرر؟',
    a: 'نعم. روتين OXIPRIME اللي كنختاروه فـ تاجكِ مصمم للشعر الجاف والمتضرر من الصباغة، الحرارة، والماء العسر.',
  },
  {
  ...
  },
  {
    ...
    a: 'نعم. يمكنك طلب أي منتج بشكل فردي بـ 199 درهم. لكن اختيار تاجكِ الأول هو الروتين الكامل لأفضل نتيجة.',
  },
];
