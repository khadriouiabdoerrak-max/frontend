...
export function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-[4.75rem] left-3 z-50 flex h-12 w-12 sm:h-14 sm:w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg md:transition-transform md:hover:scale-105 hover:bg-[#1ebe59]"
    >
